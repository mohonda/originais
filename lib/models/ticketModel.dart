...
//       tit_quantities: json['tit_quantities'] ?? 1,
//       tit_unit_value: (json['tit_unit_value'] as num).toDouble(),
//       tit_value: (json['tit_value'] as num).toDouble(),
//     );
//   }
// }
...
//   double get totalConsumo => ticketsItems.fold(0.0, (sum, item) => sum + item.tit_value);

//   factory TicketsModel.fromJson(Map<String, dynamic> json) {
//     final rawItens = json['itens_pedido'] as List<dynamic>? ?? [];
...
//       tkt_has_discount: json['tkt_has_discount'] as bool,
...
class TicketsModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      // if (tkt_id.isNotEmpty) 'tkt_id': tkt_id,
      ...
      'tkt_paiment_path': tkt_paiment_path,
    };
  }
}