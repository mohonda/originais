...
class AssociatesDetailsState extends State<AssociatesDetails> {
  ...
  final ScrollController _executiveCommiteeScrollController = ScrollController();
  ...
  void dispose() {
    ...
    _associateStatusScrollController.dispose(); // Lembre-se de liberar o controller
    _sanctionScrollController.dispose(); // Lembre-se de liberar o controller
    _executiveCommiteeScrollController.dispose(); // Lembre-se de liberar o controller
          ...
          children: [
            ...
            if (!temItens)
              ...
              ConstrainedBox(
                ...
                child: Scrollbar(
                  controller: _journeyScrollController, // <--- PASSE O CONTROLLER AQUI
            ...
            children: [
              ...
              if (!temItens)
                ...
                ConstrainedBox(
                  constraints: const BoxConstraints(maxHeight: 280),
                  child: Scrollbar(
                    controller: _associateStatusScrollController, // <--- PASSE O CONTROLLER AQUI
                    thumbVisibility: true,
                    child: SingleChildScrollView(
                      controller: _associateStatusScrollController, // <--- PASSE O CONTROLLER AQUI
                      scrollDirection: Axis.vertical,
                      ...
                      child: Column(
                        ...
                        children: historyList.map((item) {
                          ...
                          final String percent = item.pas_monthly_percent?.toString() ?? '-';
                          final String data = generalService.formatarDataBr(
          ...
          children: [
            ...
            if (!temItens)
              ...
              ConstrainedBox(
                constraints: const BoxConstraints(maxHeight: 280),
                child: Scrollbar(
                  controller: _sanctionScrollController, // <--- PASSE O CONTROLLER AQUI
                  thumbVisibility: true,
                  child: SingleChildScrollView(
                    controller: _sanctionScrollController, // <--- PASSE O CONTROLLER AQUI
                    scrollDirection: Axis.vertical,
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: historyList.map((item) {
                        final String san_name = item.san_name?.toString() ?? '-';
                        final String psan_desc = item.psan_desc.toString() ?? '-';
                       
                        final String psan_value = generalService.currencyMoneyBr(
                          item.psan_valor,
                        );                        
                        
                        final String dateStart = generalService.formatarDataBr(
                          item.psan_date_start.toString(),
                        );
          ...
          children: [
            ...
            if (!temItens)
              ...
              ConstrainedBox(
                constraints: const BoxConstraints(maxHeight: 280),
                child: Scrollbar(
                  controller: _executiveCommiteeScrollController, // <--- PASSE O CONTROLLER AQUI
                  thumbVisibility: true,
                  child: SingleChildScrollView(
                    controller: _executiveCommiteeScrollController, // <--- PASSE O CONTROLLER AQUI
                    scrollDirection: Axis.vertical,
