...
class MonthlyPaymentsProfileState extends State<MonthlyPaymentsProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    // --- FUNÇÃO AUXILIAR ---
    // Agrupamos a lógica aqui para usar tanto no campo de texto quanto na miniatura
    ...
    return Scaffold(
      appBar: const CustomFloatingAppBar(title: 'Comprovante de Pagamento'),
      body: Padding(
                  ...
                  IntrinsicHeight(
                    child: Row(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              ListenableBuilder(
                                ...
                                builder: (context, child) {
                                  final listaFormas = bdFormaPagamentoController
                                      .formaPagamentoNotifier
                                      .value;
                              ...
                              ValueListenableBuilder(
                                ...
                                builder: (context, value, child) {
                                  final newValue = value?.comprovantepag ?? "";

                                  // ✅ Atualiza o controller com segurança APÓS o término da renderização
                                  if (comprovantepag.text != newValue) {
                                    WidgetsBinding.instance
                                        .addPostFrameCallback((_) {
                                          comprovantepag.text = newValue;
                                        });
                                  }

                                  return TextFormField(
                                    controller: comprovantepag,
                                    readOnly: true,
                                    textAlign: TextAlign.end,
                                    onTap: selecionarEEnviarFoto,
                                    decoration: const InputDecoration(
                                      labelText: 'Comprovante (URL):',
                                      prefixIcon: Icon(Icons.photo_album_sharp),
                                      border: OutlineInputBorder(),
                                    ),
                                    validator: (val) =>
                                        val == null || val.trim().isEmpty
                                        ? 'Informe o comprovante'
                                        : null,
                                  );
                                },
                              ),
                        ...
                        // DIREITA: Mesma proporção (flex: 1) do Mês/Ano lá em cima
                        Expanded(
                          flex: 1,
                          child: SizedBox(
                            height:
